...
module "iam" {
  ...
  create_oidc_provider = false # OIDC provider is global — created once in staging
}
...
# ECR is shared — no separate prod repo; images tagged prod-* vs staging-*
data "aws_ecr_repository" "api" {
  name = "nightingale/api"
}
